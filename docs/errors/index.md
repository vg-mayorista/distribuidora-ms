...
1. Crear un archivo nuevo en esta carpeta con nombre descriptivo en kebab-case.
2. Respetar el formato: título, módulo, patrón, diagnóstico/fix.
3. Agregar la fila correspondiente en este índice.
